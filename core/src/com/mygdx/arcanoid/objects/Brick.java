...
public class Brick {
    ...
    private boolean carriesModifier;
    ...
    public boolean carriesModifier() {
        return carriesModifier;
    }

    public void setCarriesModifier(boolean carriesModifier) {
        this.carriesModifier = carriesModifier;
    }
